...
if st.session_state.step == 1:
    ...
    # שפות נוספות – אופציונלי (נדרש לפרט רק אם בחרו "אחר...")
    st.multiselect("ציין/י שפות נוספות (ברמת שיחה)",   # <-- לא חובה
    ...
    if nxt:
        ...
        # שפות נוספות אינן חובה — רק אם נבחר 'אחר...' חובה לפרט
